...
import taggers.ennTaggerModel3.ennModelNpModel3 as ennModelNp
...
if __name__ == '__main__':    
    ...
    print("\nENN Model 3 Tagger testing ...\n")

    tfn = templateFileName.TemplateFileName(base, bench)
    tfn.builfResultFile('enn3', batch = batchTraining)
